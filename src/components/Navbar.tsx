...
const openLink = (path: string) => {
    const linkObj = {
        "github": "https://github.com/drehan7",
        "linkedin": "https://www.linkedin.com/in/dsrehan/",
    }

    if (Object.keys(linkObj).includes(path)) {
        ...
        <nav className="flex items-center justify-between flex-wrap p-6">
          ...
          <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div className="text-lg lg:flex-grow">
              ...
              <a href="/projects" className="block mt-4 lg:inline-block lg:mt-0 text-red-500 hover:text-white mr-4 text-xl">
                Projects
              </a>
              <a href="/contact" className="block mt-4 lg:inline-block lg:mt-0 text-red-500 hover:text-white mr-4 text-xl">
                Contact
              </a>
              <a href="/resume" className="block mt-4 lg:inline-block lg:mt-0 text-red-500 hover:text-white text-xl">
                Resume
              </a>
            </div>
            <div>
